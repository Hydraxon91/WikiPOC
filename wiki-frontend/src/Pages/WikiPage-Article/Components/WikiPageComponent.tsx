...
const WikiPageComponent = ({page, setDecodedSlug, activeTab, images}) => {
  ...
  return (
    <div className="article" style={{backgroundColor: styles.articleColor, '--article-right-color': styles.articleRightColor, '--article-right-inner-color': styles.articleRightInnerColor, '--footer-link-color': styles.footerListLinkTextColor, display: activeTab !== 'wiki' ? 'none' : undefined} as any}>
      {page && (
